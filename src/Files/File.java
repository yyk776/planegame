...
public class File implements Serializable{
	...
	private int [] FilePlanes = {0,0,0,0,0,0};
	private int [] FileHonors = {0,0,0,0,0,0};
	private int [] FileCharpters = {0,0,0,0,0,0};
	
	public File() {
		super();
	}
	
	public File(String fileId, String fileName, int[] filePlanes, int[] fileHonors, int[]fileCharpters) {
		super();
		this.FileId = fileId;
